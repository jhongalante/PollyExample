...
namespace PollyExample
{
    class Program
    {
        ...
        static void Retry()
        {
            var retry = Policy.Handle<Exception>().Retry(2);
        ...
        static void WaitAndRetry()
        {
            var waitRetry = Policy
                                .Handle<Exception>()
                                .WaitAndRetry(5, i => TimeSpan.FromSeconds(5), (result, timeSpan, retryCount, context) =>
                                {
        ...
        static void CallWS()
        {
            ...
            var result = httpClient.GetAsync("http://demo8711330.mockable.io/polly").Result;
